<template>
  <div class="flex justify-center items-center h-container">
    <div
      class="register-card border-1 rounded-lg border-green-400 shadow-sm shadow-green-400 flex flex-col gap-10 p-10 hover:shadow-md hover:shadow-blue-600"
    >
      ...
      <div class="flex justify-center gap-2 items-center">
        Already have account to <ULink to="/login" class="hover:text-green-400 font-bold"> Login Here </ULink>
      </div>
    </div>
  </div>
</template>
